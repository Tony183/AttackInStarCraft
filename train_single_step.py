...
parser.add_argument('--data', type=str, default='./data/multivariate-time-series-data/solar-energy/solar_AL.txt',
                    help='location of the data file')
parser.add_argument('--log_interval', type=int, default=2000, metavar='N',
                    help='report interval')
parser.add_argument('--save', type=str, default='model/model-solar-3.pt',
